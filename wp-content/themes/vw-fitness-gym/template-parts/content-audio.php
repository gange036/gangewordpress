      ...
      <?php if( get_theme_mod( 'vw_fitness_gym_toggle_postdate',true) != '' || get_theme_mod( 'vw_fitness_gym_toggle_author',true) != '' || get_theme_mod( 'vw_fitness_gym_toggle_comments',true) != '') { ?>
        <div class="post-info">
          ...
          <?php if(get_theme_mod('vw_fitness_gym_toggle_comments',true)==1){ ?>
            <i class="<?php echo esc_attr(get_theme_mod('vw_fitness_gym_toggle_comments_icon','fas fa-comments')); ?>"></i><span class="entry-comments"><?php comments_number( __('0 Comment', 'vw-fitness-gym'), __('0 Comments', 'vw-fitness-gym'), __('% Comments', 'vw-fitness-gym') ); ?> </span>
          <?php } ?>
          <hr>
        </div>    
      <?php } ?>  
